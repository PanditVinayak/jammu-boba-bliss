      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Bringing authentic bubble tea flavors to the heart of Jammu.
            </p>
            <div className="mt-6 flex space-x-4">
              ...
              <a href="https://twitter.com" className="text-gray-500 hover:text-boba-primary">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            ...
            <address className="mt-4 not-italic text-sm text-gray-600">
              ...
              <p>Jammu, 180004</p>
              <p className="mt-2">
                <a href="tel:+910000000000" className="hover:text-boba-primary">+91 00000 00000</a>
              </p>
              <p>
                <a href="mailto:hello@jammuboba.com" className="hover:text-boba-primary">hello@jammuboba.com</a>
              </p>
            </address>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-center text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Jammu Boba Bliss. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
